<template>
  <section class="text-gray-400 bg-gray-900 font-serif">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-wrap -m-4">
        <div class="md:w-1/3">
          <div
            class="m-4 h-auto border-2 border-gray-800 rounded-lg overflow-hidden"
          >
            <img
              class="lg:h-48 md:h-36 w-full object-cover object-bottom"
              src="https://dl.dropboxusercontent.com/s/66tmv492043y84e/720x420.png"
              alt="blog"
            />
            <div class="p-6">
              <h2
                class="tracking-widest text-xs font-mono font-medium text-gray-500 mb-1"
              >
                CATEGORY
              </h2>
              <h1 class="font-mono text-lg font-medium text-white mb-3">
                The Catalyzer
              </h1>
